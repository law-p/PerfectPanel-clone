...
<form method="post" action="loginprocessor.php">
 <div class="container d-flex flex-column"> 
  <div class="row align-items-center justify-content-center p-5">
        <div class="col-12 col-md-8 col-lg-4">
          <div class="card shadow-sm">
            <div class="card-body">
              <div class="mb-4">
              <h4 class="text-success text-center">Login Now</h4>
  ...
  <p class="text-center mt-5">Don't have an account?
                                    <a href="register.php"><span class="text-success">Sign Up</span></a>
                                  </p>
   <a href="#"><p class="text-center text-success">Forgot your password?</p></a>
